          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                ...
                className="font-mono bg-white border-gray-300 focus:border-blue-500 focus:ring-blue-500"
              />
            </div>
          </div>
        );
        ...
        <div className="flex items-center gap-4 flex-wrap">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center gap-2 px-3 py-2 text-sm border border-gray-300 rounded-md bg-white hover:bg-gray-50 focus:border-blue-500 focus:ring-blue-500 min-w-[140px] justify-between"
            >
                ...
                {AUTH_TYPES.map((type) => (
                  <button
                    ...
                    className={`w-full text-left px-3 py-2 text-sm hover:bg-gray-50 transition-colors ${
                      activeTab.auth.type === type.value ? 'bg-blue-50 text-blue-600' : 'text-gray-700'
                    }`}
                  >
                    {type.label}
                  </button>
